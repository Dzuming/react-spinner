...
var keyFramesStyle = function keyFramesStyle(type) {
  return {
    styles: ['\n  @keyframes bounceIn{\n    0%{\n      opacity: 0;\n      transform: scale(0.3) translate3d(0,0,0);\n    }\n    50%{\n      opacity: 0.9;\n      transform: scale(1.1);\n    }\n    80%{\n      opacity: 1;\n      transform: scale(0.89);\n    }\n    100%{\n      opacity: 1;\n      transform: scale(1) translate3d(0,0,0);\n    }\n  }\n  ', '\n  @-webkit-keyframes run {\n    0% { left: 0;}\n    50%{ left : 100%;}\n    100%{ left: 0;}\n  }', '\n  ' + pulse(type) + '\n  ', '\n  ' + spin(type) + '\n  ']
  };
};

var Animation = function Animation(type, time) {
  var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'infinite';
...
exports.keyFramesStyle = keyFramesStyle;
...
var _injectStyle = __webpack_require__(5);
...
var Spinner = function (_Component) {
  ...
  function Spinner(props) {
    ...
    _this.state = {};
    (0, _Animation.keyFramesStyle)(props.shape).styles.map(function (animation) {
      return (0, _injectStyle2.default)(animation);
    });
    return _this;
  }
  ...
  _createClass(Spinner, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('div', { style: _extends({}, _Spinner2.default.background) }),
        _react2.default.createElement('div', {
          style: _extends({}, _Shapes2.default[shape], _Position2.default.center, (0, _Animation.Animation)(animation, time, duration)) })
      );
    }
  }]);
...
Spinner.propTypes = {
  ...
  shape: _propTypes2.default.string.isRequired
};
exports.default = Spinner;
